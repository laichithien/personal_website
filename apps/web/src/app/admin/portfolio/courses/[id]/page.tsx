...
export default function EditCoursePage() {
  ...
  const { data: course, isLoading } = usePortfolioCourse(courseId);
  const { mutate: updateCourse, isPending } = useUpdatePortfolioCourse();
      ...
      { id: courseId, data: formData },
      {
        ...
        onError: (err: unknown) => {
          if (err && typeof err === "object" && "response" in err) {
            ...
            setError(
              axiosError.response?.data?.detail || "Failed to update course"
            );
          } else {
